...
def main():
    ...
    # Calcul interne seulement: +0.55%
    tx = round(rate_google * 1.0055, 2)
    ...
    message += f"🇨🇦 100 CAD = <b>{round(tx * 100, 2)} XAF</b> 🇨🇲\n"
    message += f"🇨🇦 500 CAD = <b>{round(tx * 500, 2)} XAF</b> 🇨🇲"
    
    send_telegram(message)
    print(f"Taux envoyé: {tx} XAF")
